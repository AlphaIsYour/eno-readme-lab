...
export default function MarkdownPreview({ markdown }: MarkdownPreviewProps) {
  ...
  return (
    <div className="h-full flex flex-col">
      {/* Stats Bar */}
      <div className="flex items-center gap-3 px-6 py-2.5 bg-gray-50/80 dark:bg-gray-900/80 border-b border-gray-200 dark:border-gray-800 text-xs text-gray-500 dark:text-gray-400 font-medium select-none">
      ...
      {/* Markdown Content */}
      <div className="prose prose-sm dark:prose-invert max-w-none p-6 overflow-y-auto flex-1
